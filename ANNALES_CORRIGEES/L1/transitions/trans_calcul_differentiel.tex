...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[align=center] at (current page.center) {%
    {\fontsize{30}{38}\bfseries\selectfont CALCUL DIFFÉRENTIEL}\\[0.5cm]
    {\fontsize{26}{34}\bfseries\selectfont DANS $\mathbb{R}$}\\[1.2cm]
    {\large\itshape Limites - Dérivées - Développements limités}\\[0.5cm]
    {\large\itshape Étude de fonctions et optimisation}\\[2cm]
