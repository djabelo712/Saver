...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[align=center] at (current page.center) {%
    {\fontsize{30}{38}\bfseries\selectfont CALCUL INTÉGRAL}\\[0.5cm]
    {\fontsize{26}{34}\bfseries\selectfont DANS $\mathbb{R}$}\\[1.2cm]
    {\large\itshape Primitives - Intégration par parties}\\[0.5cm]
    {\large\itshape Changement de variable - Intégrales impropres}\\[2cm]
