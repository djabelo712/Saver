...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[align=center] at (current page.center) {%
    {\fontsize{24}{32}\bfseries\selectfont MÉCANIQUE DU POINT MATÉRIEL}\\[1.2cm]
    {\large\itshape Cinématique - Dynamique newtonienne}\\[0.5cm]
    {\large\itshape Énergie - Moment cinétique - Oscillations}\\[2cm]
